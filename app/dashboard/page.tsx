...
export default function Dashboard() {
  ...
  const availableProjects = [
    {
      ...
      description:
        "WordPress-based blog with custom theme and SEO optimization",
  ...
  return (
    ...
    >
      {/* Header */}
      <header
        className={`shadow-lg border-b transition-all duration-300 backdrop-blur-sm ${
          isDarkMode
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2 sm:space-x-4">
              <h1
                className={`text-xl sm:text-2xl font-bold bg-gradient-to-r bg-clip-text text-transparent ${
                  isDarkMode
              ...
              <button
                className={`md:hidden p-2 hover:text-gray-500 transition-colors ${
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              >
                ...
                <span className="absolute -top-1 -right-1 h-4 w-4 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs rounded-full flex items-center justify-center animate-pulse">
                  3
                </span>
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Navigation Tabs */}
        <div
          className={`flex space-x-4 sm:space-x-8 mb-6 sm:mb-8 border-b overflow-x-auto transition-colors duration-300 ${
        ...
        {activeTab === "overview" && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div
                className={`rounded-2xl shadow-xl p-6 transition-all duration-300 hover:scale-105 border ${
                  isDarkMode
            ...
            >
              <h3
                className={`text-base sm:text-lg font-semibold mb-4 transition-colors ${
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                <button
                  className={`flex items-center justify-center space-x-2 p-3 sm:p-4 border-2 border-dashed rounded-lg transition-all ${
                    isDarkMode
                ...
                <button
                  className={`flex items-center justify-center space-x-2 p-3 sm:p-4 border-2 border-dashed rounded-lg transition-all sm:col-span-2 lg:col-span-1 ${
                    isDarkMode
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    >
                      Sarah joined your "E-commerce Website" project
                    </p>
                    <p
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    >
                      You completed a milestone in "Mobile App for Food
                      Delivery"
                    </p>
                    <p
                      className={`text-xs transition-colors ${
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    >
                      New project recommendation: "Blog Website for Travel
                      Agency"
                    </p>
                    <p
                      className={`text-xs transition-colors ${
              ...
              {activeProjects.map((project) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4">
                    <div
                      className={`flex items-center space-x-2 text-xs sm:text-sm transition-colors ${
                        isDarkMode ? "text-gray-400" : "text-gray-600"
                      }`}
                    >
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                    <button className="text-indigo-600 hover:text-indigo-800 font-medium text-sm sm:text-base text-left">
                      View Details
                    </button>
        ...
        {activeTab === "available" && (
          <div className="space-y-4 sm:space-y-6">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              ...
              <button
                className={`flex items-center justify-center space-x-2 px-4 py-2 border rounded-lg text-sm sm:text-base transition-colors ${
                  isDarkMode
                    ? "border-gray-700 hover:bg-gray-800 text-gray-300"
                    : "border-gray-300 hover:bg-gray-50 text-gray-700"
                }`}
            ...
            <div className="grid gap-4 sm:gap-6">
              {availableProjects.map((project) => (
                <div
                  key={project.id}
                  className={`rounded-lg shadow p-4 sm:p-6 border-l-4 border-green-500 transition-colors duration-200 ${
                ...
                >
                  <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4 gap-3">
                    <div className="flex-1">
                      ...
                      <div
                        className={`flex flex-col sm:flex-row sm:items-center sm:space-x-4 mt-2 text-xs sm:text-sm gap-1 sm:gap-0 transition-colors ${
                          isDarkMode ? "text-gray-500" : "text-gray-500"
                        }`}
                      >
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.skills.map((skill) => (
                      <div
                        key={skill}
                        className="flex items-center space-x-1 px-2 sm:px-3 py-1 bg-green-100 rounded-full text-xs sm:text-sm text-green-800"
                      >
                        {skillIcons[skill] || <Code className="w-4 h-4" />}
                        <span>{skill}</span>
                      </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                      <button
                        className={`px-3 sm:px-4 py-2 border rounded-md text-xs sm:text-sm text-center transition-colors ${
                          isDarkMode
                            ? "border-gray-700 hover:bg-gray-800 text-gray-300"
                            : "border-gray-300 hover:bg-gray-50 text-gray-700"
                        }`}
        ...
        {(activeTab === "team" || activeTab === "profile") && (
          <div
            className={`rounded-lg shadow p-12 text-center transition-colors duration-200 ${
              isDarkMode ? "bg-gray-900 border border-gray-800" : "bg-white"
            }`}
          >
            <div
