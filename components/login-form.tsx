      ...
      <form>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="text-center text-sm">
              ...
              <a href="/signup" className="hover:underline text-cyan-500  underline-offset-4">
                Sign up
              </a>
            </div>
          </div>
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Button variant="outline" type="button" className="w-full group bg-zinc-900 text-white hover:cursor-pointer hover: transition-all ">
            <IconBrandGithub className="h-4 w-4 text-white group-hover:text-black" />

              Continue with Github
             
            </Button>
            <Button variant="outline" type="button" className="w-full bg-zinc-900 hover:cursor-pointer hover:bg-white/80  ">
